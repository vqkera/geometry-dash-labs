...
function GamePreview() {
  ...
  const statusText = isGameOver
    ...
    : isRunning
      ? `${playerProfile.playerName} у грі. Перестрибуйте перешкоди.`
  ...
  return (
    <section className={styles.preview}>
      <div className={styles.topBar}>
        <div>
          <p className={styles.caption}>Гравець: {playerProfile.playerName}</p>
      ...
      <div className={styles.gameField} onClick={jump}>
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: playerProfile.cubeColor,
