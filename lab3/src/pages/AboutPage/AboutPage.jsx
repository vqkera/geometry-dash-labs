...
function AboutPage() {
  ...
  return (
    <section className={styles.pageCard}>
      ...
      <p>
        Тема проєкту — {gameData.theme}. Основні дані гри зберігаються у
        загальному контексті, тому їх можна використовувати на різних сторінках
        додатку без дублювання коду.
      </p>
